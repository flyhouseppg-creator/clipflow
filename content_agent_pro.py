...
.wrap:has(.progress-wrap.active) .flow .f:nth-of-type(3) .n{background:var(--accent);color:#04111c;border-color:transparent}
.wrap:has(.progress-wrap.active) .flow .f:nth-of-type(3) span{color:var(--text)}
.sec{margin-top:18px}
...
.video-preview{width:100%;border-radius:var(--r);margin-top:12px;display:none;max-height:280px;object-fit:cover;background:#000}
...
.gen{width:100%;margin-top:22px;padding:16px;border:none;border-radius:var(--r);background:var(--accent);color:#04111c;font:inherit;font-size:16px;font-weight:500;cursor:pointer;transition:.2s;box-shadow:0 12px 30px -12px var(--accent)}
.gen:hover:not(:disabled){filter:brightness(1.08);transform:translateY(-1px)}
.gen:disabled{background:var(--surface-2);color:var(--muted);box-shadow:none;cursor:not-allowed}
.progress-wrap{display:none;margin-top:22px}
.progress-wrap.active{display:block}
.stepper{display:grid;grid-template-columns:repeat(4,1fr);gap:8px}
.step{padding:12px 10px;border-radius:var(--r);background:var(--surface);border:1px solid var(--border);display:flex;flex-direction:column;gap:8px;transition:.2s}
.step.active{background:var(--accent-soft);border-color:var(--accent-border)}
.step-icon{width:32px;height:32px;border-radius:9px;background:var(--surface-2);display:grid;place-items:center;font-size:15px;transition:.2s}
.step.active .step-icon{background:var(--accent)}
.step-info h3{font-size:12px;font-weight:500;margin:0}
.step-info p{font-size:11px;color:var(--muted);margin:0}
.progress-msg{text-align:center;color:var(--muted);font-size:14px;margin-top:14px;min-height:20px}
...
<button class="gen" id="genBtn" disabled>Genera clip</button>
<div class="progress-wrap" id="progressWrap"><div class="stepper"><div class="step" id="step1"><div class="step-icon">✂️</div><div class="step-info"><h3>Taglio</h3><p>Silenzi</p></div></div><div class="step" id="step2"><div class="step-icon">🎤</div><div class="step-info"><h3>Trascrizione</h3><p>Audio in testo</p></div></div><div class="step" id="step3"><div class="step-icon">📝</div><div class="step-info"><h3>Sottotitoli</h3><p>Karaoke</p></div></div><div class="step" id="step4"><div class="step-icon">📦</div><div class="step-info"><h3>Export</h3><p>Pronto</p></div></div></div><div class="progress-msg" id="progressMsg">Preparazione…</div></div>
