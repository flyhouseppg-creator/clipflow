...
.gen{position:relative;width:100%;padding:16px;border:none;border-radius:var(--r);background:var(--accent);color:#04111c;font:inherit;font-size:16px;font-weight:500;cursor:pointer;transition:background .2s,filter .2s,transform .2s;box-shadow:0 12px 30px -12px var(--accent)}
...
.gen-check{display:none;font-size:1.6em;line-height:0;color:var(--success);text-shadow:0 1px 3px rgba(0,0,0,.45)}
.gen.done .gen-check{display:inline-block}
...
<div class="gen-wrap"><button class="gen" id="genBtn" disabled><span class="gen-fill" id="genFill"></span><span class="gen-label" id="genLabel"><span class="gen-check" id="genCheck">✓</span><span id="genText">Genera clip</span></span></button></div>
